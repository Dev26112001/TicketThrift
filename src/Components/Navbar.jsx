...
//                     <div
//                       key={city.name}
//                       className="flex flex-col items-center p-4 bg-gray-100 rounded-lg hover:bg-blue-100 hover:shadow-lg transition-all duration-300 ease-in-out cursor-pointer"
//                       onClick={() => {
